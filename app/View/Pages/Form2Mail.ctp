<?php
  ...
  // set to false if you prefer to use plain text format for your emails
  // Note: For Yahoo hosting is better to use the plain text format if your
  //       has more than 6 fields.
  ...
  function send_mail($emailaddress, $fromaddress, $emailsubject, $body, $attachments=false)
  {
      ...
      $mail->IsHTML(USE_HTML_FORMATTING); // send as HTML
