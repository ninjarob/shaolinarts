<div class="users form">
    ...
    <table>
        <thead>
        <tr>
            <th><?php echo $this->Form->checkbox('all', array('name' => 'CheckAll', 'id' => 'CheckAll')); ?>
            </th>
        ...
        <tr class="zebra">' ?>
            ...
            <td><?php echo $this->Html->link( $user['User']['username'] , array('action'=>'edit',
            ...
            <td style="text-align: center;"><?php //echo $this->Time->niceShort($user['User']['modified']);?>
            </td>
